...
const mockMediaFiles: MediaFile[] = [
  ...
  },
  {
    ...
    thumbnailUrl: '/images/baby-birthday.jpg',
  ...
  {
    id: '4',
    name: 'wedding-dance.jpg',
    type: 'image',
    format: 'JPEG',
    size: 2.8,
    dimensions: { width: 1920, height: 1080 },
    uploadedAt: new Date('2024-07-20'),
    thumbnailUrl: '/images/img (2).jpg',
